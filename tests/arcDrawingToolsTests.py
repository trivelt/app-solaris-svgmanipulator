...
class TestArcTools(unittest.TestCase):
    ...
    def testDescribePathForTextClockwise(self):
        ...
        self.assertEqual(ArcDrawingTools.describeArcClockwise(1000, 5000, 3000, 15, 87), expectedPath)

        expectedPath = "M 450.0 200.0 A 150 150 0 0 0 193.933982822 93.933982822"
        self.assertEqual(ArcDrawingTools.describeArcClockwise(300, 200, 150, -45, 90), expectedPath)
    ...
    def testDescribePathForTextAntiClockwise(self):
        ...
        self.assertEqual(ArcDrawingTools.describeArcAnticlockwise(1000, 5000, 3000, 15, 87), expectedPath)

        expectedPath = "M 193.933982822 93.933982822 A 150 150 0 0 1 450.0 200.0"
        self.assertEqual(ArcDrawingTools.describeArcAnticlockwise(300, 200, 150, -45, 90), expectedPath)
